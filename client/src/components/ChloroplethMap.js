...
const ChloroplethMap = ({
  ...
  setChloroProperty
    ...
    }, [map, storeRef, colors, sizes, opacities, hasStroke, propertyData, handlePropertyDataLoad, chloroProperty, setChloroProperty, store.currentMap.graphics.geojson, usedColors]);
