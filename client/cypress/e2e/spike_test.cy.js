describe('Spike Map Tests', () => {
  beforeEach(() => {
    cy.visit('http://localhost:3000');
    // cy.get('[data-testid=guest-button]').click();
  });

  it('should create spike map', () => {
    ...
    cy.get(':nth-child(5) > .MuiButtonBase-root > .PrivateSwitchBase-input').check();
  ...
  it('should delete created spike map', () =>{
    cy.get('[data-testid="username-field"]').type('cypress');
    cy.get('[data-testid="password-field"]').type('abcd1234');
    cy.get('[data-testid="login-button"]').click();
  ...
  it('should fail to create spike map', () => {
    cy.get('[data-testid="username-field"]').type('cypress');
    cy.get('[data-testid="password-field"]').type('abcd1234');
    cy.get('[data-testid="login-button"]').click();
    ...
    cy.get('.MuiBox-root > .MuiGrid-container > .MuiGrid-root').should('have.text', 'Create Map');
    cy.get('.MuiBox-root > .MuiGrid-container > .MuiGrid-root').click();
    cy.get('body').click();
